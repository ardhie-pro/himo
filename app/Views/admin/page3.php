            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-title-box">
                        <h4 class="page-title">Halaman Page 3</h4>
                        <ol class="breadcrumb">
                        ...
                        <div class="card m-b-20">
                            ...
                            <?php if ($hasil != null) {
                                foreach ($hasil as $key => $value) { ?>
                                    <div class="p-4">
                                        <form action="<?= base_url('aksiupdatepage3') ?>" method="post" enctype="multipart/form-data">
                                            <div class="form-group">
                                                <div class="form-group">
                                                    <label>Title About</label>
                                                    <div>
                                                        <input type="hidden" name="page3_id" class="form-control floating-label" value="<?= $value['page3_id']; ?>">
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="<?= base_url('aksipage3') ?>" method="post" enctype="multipart/form-data">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-danger" href="<?= base_url('deleteupage3/' . $sw['page3_id']); ?>">Hapus</a>
                                                    <a class="btn btn-warning" href="<?= base_url('updatepage3/' . $sw['page3_id']); ?>">Edit</a>
                                                </td>
                                            </tr>
                                        <?php }  ?>
