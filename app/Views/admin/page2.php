            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-title-box">
                        <h4 class="page-title">Halaman Page 2</h4>
                        <ol class="breadcrumb">
                        ...
                        <div class="card m-b-20">
                            ...
                            <?php if ($hasil != null) {
                                foreach ($hasil as $key => $value) { ?>
                                    <div class="p-4">
                                        <form action="<?= base_url('aksiupdatepage2') ?>" method="post" enctype="multipart/form-data">
                                            <div class="form-group">
                                                <div class="form-group">
                                                    <label>Title Berita</label>
                                                    <div>
                                                        <input type="hidden" name="page2_id" class="form-control floating-label" value="<?= $value['page2_id']; ?>">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <input type="text" name="text4" class="form-control floating-label" value="<?= $value['text4']; ?>">
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title mt-0" id="myModalLabel">Buat Halaman</h5>
                                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                            </div>
                                            <div class="modal-body">
                                                <form action="<?= base_url('aksipage2') ?>" method="post" enctype="multipart/form-data">

                                                    <div class="form-group">
                                                        <label>Title Beita</label>
                                                        <div>
                                                    ...
                                                    <div class="form-group">
                                                        <label>Instagram 1</label>
                                                        <div>
                                                            <input type="text" name="text3" class="form-control floating-label">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        <label>Instagram 2</label>
                                                        <div>
                                                            <input type="text" name="text4" class="form-control floating-label">
                                                        </div>
                                                    </div>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-danger" href="<?= base_url('deletepage2/' . $sw['page2_id']); ?>">Hapus</a>
                                                    <a class="btn btn-warning" href="<?= base_url('updatepage2/' . $sw['page2_id']); ?>">Edit</a>
                                                </td>
                                            </tr>
                                        <?php }  ?>
